          ...
          <div>
            <Link href="/">
              <a itemProp="author" itemScope itemType="http://schema.org/Person" className={classes.iconContainer}>
                <img itemProp="logo" itemScope itemType="https://www.schema.org/ImageObject" className={classes.icon} src="/images/joshhills-dev-logo-pride-plus.svg" alt="Josh Hills logo of the letter J in a square"/>
